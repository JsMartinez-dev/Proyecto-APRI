...
public class MaterialEducativo {
    ...
    public MaterialEducativo(int id_materialEducativo, String categoria, String nombre, String año_publicacion, String tipo, String descripcion, boolean estado, Usuario usuario) {
