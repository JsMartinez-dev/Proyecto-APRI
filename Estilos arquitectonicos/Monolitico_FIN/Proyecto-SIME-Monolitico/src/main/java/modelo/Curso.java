...
public class Curso extends MaterialEducativo {
    ...
    public Curso(int id_curso, int duracion, int id_materialEducativo, String categoria, String nombre, String año_publicacion,  String descripcion, boolean estado, Usuario usuario) {
